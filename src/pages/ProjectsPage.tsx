  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit">
      ...
      >
            ...
            <article key={project.id} className="group glass-card overflow-hidden">
              ...
              <div className="p-7">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <h2 className="font-display text-3xl font-semibold text-textPrimary">{project.name}</h2>
                ...
                <p className="mt-5 text-base leading-7 text-textPrimary/72">{project.description}</p>
        ...
        <div className="mt-12 glass-card flex flex-col gap-5 p-7 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-accent">Need more detail?</p>
            <h3 className="mt-2 font-display text-3xl font-semibold text-textPrimary">I can turn ideas into shipping products with clean execution.</h3>
